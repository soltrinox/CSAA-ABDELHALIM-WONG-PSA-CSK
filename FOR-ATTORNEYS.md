...
## 2. Why plaintiffs’ counsel may treat this as economically serious

Quantified bands and non-duplication rules are in [`RISK.SURFACE.md`](RISK.SURFACE.md) and the mirror under [`risk-surface/MASTER-CONSOLIDATED.md`](risk-surface/MASTER-CONSOLIDATED.md). At a high level (median figures as modeled there):

- **802 (CSAA-only UCL / fraud):** Modeled **$142.8M** all-in for CSAA in the central 5:1 punitive row, with an **upper** CSAA column of **$178.5M** on 125% inputs (see [`risk-surface/per-case/FRAUD-UCL-802-CGC-25-631802.md`](risk-surface/per-case/FRAUD-UCL-802-CGC-25-631802.md)).  
- ***Prentice* channel:** Four years of underlying-litigation cost is modeled as **$1.5M** median consequential damages in the 802 compensatory table (same file).  
- **801 attorney-deceit (B&P Code § 6128(a)):** Treble damages and reasonable attorney’s fees are **pleaded** against named individuals (Count 6); per-defendant law-firm bands are in the **801** per-case file (see [`risk-surface/per-case/EQUITY-801-CGC-25-631801.md`](risk-surface/per-case/EQUITY-801-CGC-25-631801.md)).  
- **5:1 punitive band** on 802 compensatory (central estimate) is in the same 802 per-case table.

**One page for underwriting:** [`RISK-AND-ECONOMICS.md`](RISK-AND-ECONOMICS.md).
...
## 4. Three forced binaries (defense tension)
...
## 8. Contact and intake (public record)

- **Plaintiff:** Franciscus Dylan Rosario.  
- **Status:** In pro per (see court-filed proofs of service and case captions in this repository’s PDFs).  
- **Service email (as used on filed POS-style documents mirrored under `risk-surface/`):** `soltrinox@gmail.com`  
- **Civil litigation fund (public):** [SpotFund](https://www.spotfund.com/story/88e93d31-3915-409e-b4ac-e29a5d1fd6d6) (same link as [homepage Reference](README.md#reference)).  
- **Reply window:** Business hours Pacific, subject to hearing / filing deadlines in [`HEARINGS-CALENDAR.md`](HEARINGS-CALENDAR.md).

---

## 9. Disclaimer

Inquiries from **licensed California attorneys** are welcome. This page is **not** legal advice and does **not** create an attorney-client relationship.
