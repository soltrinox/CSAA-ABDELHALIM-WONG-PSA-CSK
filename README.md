...
**Last refresh:** September 23, 2026
...
On February 4, 2021, a commercial driver struck Rosario from behind in a San Francisco crosswalk. The driver called 911. On a recording he later authenticated under oath, he said he had barely hit the man. Officers wore cameras. Dispatch logged the collision. Rosario was admitted to the trauma ICU at Zuckerberg San Francisco General Hospital. Twenty days after that admission, he received an unsolicited, unilateral claims letter he had never requested. The letter claimed CSAA had performed an investigation and had concluded they were not liable.

There was never any communication from CSAA about the defendant's 911 confession. There was never any communication about the body-cam video with third-party eyewitness statements. There was never any communication about the validity or merits of the victim-plaintiff's own statement on that 911 recording, declaring to operators that the man in the van had hit him. None of this was collected and considered. CSAA certified a search it did not make. That is not claims handling. It is a disgusting abuse of the word "investigation." It is institutional malice of a particular kind: the kind you practice only if you are sure the other side is too broken, too poor, or too exhausted to prove the file was empty.
...
Insurance is supposed to stand between a body and ruin. On this record CSAA stood between a body and the truth, then billed him for asking a judge to look. That is despicable. Every California driver who pays CSAA for peace of mind deserves to know what the word "investigation" was worth on a letter sent twenty days after ICU admission, unsolicited.
...
On February 4, 2021 a pedestrian was struck in the crosswalk at Tehama and 5th Street in San Francisco. Everything on this site descends from what the insurer did with that claim and from what its lawyers later told a court about the evidence.
...
**Document one.** The [February 25, 2021 CSAA denial letter](MERITS-EXHIBITS/CSAA_Denial_Letter-Feb-25-2021.pdf), signed by Sarah Rash, denies the claim on the positive assertion that an investigation **was** performed and concluded. It is an ordinary-course claims communication, issued under the claim-handling regulations at 10 CCR section 2695.7, addressed to the injured claimant.

**Document two.** The January 17, 2025 declarations supporting Motions in Limine [No. 6](MERITS-EXHIBITS/CGC-21-594102-CT1-MIL-No-6_Clerk-pp-149-151.pdf) and [No. 17](MERITS-EXHIBITS/CGC-21-594102-CT1-MIL-No-17_Clerk-pp-238-241.pdf), signed under Code of Civil Procedure section 2015.5 by appointed defense counsel, represent that the investigative product **was not** in counsel's possession and was of unknown provenance. MIL No. 17 puts it in as many words: the defense has "no idea where this 911 call log or audio recording came from and who created it."
...
## Part 2. CGC-21-594102, the trial

**Where it stands.** Tried to verdict. Judgment for the defense 9 to 3 on April 23, 2025, the bare minimum civil majority in California. Three jurors would have found for the plaintiff.

**Where the defense stood.** That the silent-witness materials were of unknown origin and had not been produced in discovery. That position, taken in the January 2025 declarations, produced in-limine rulings that shaped what the jury was permitted to hear before opening statements.

**What the record then showed.** On Trial Day 7, April 16, 2025, defense counsel Priya D. Navaratnasingham said this about the same materials:

> *"Sure. They were provided by Dolan. He has had them for whatever, sure."*
> [Trial Day 7, April 16, 2025](05-TRANSCRIPTS/REPORTER-TRANSCRIPTS/Trial-Day-07-April-16-2025.pdf)

The next day the driver authenticated his own 911 call under oath:

> *"BOOM! I just hit him. HIT HIM. There was barely anything."*
> Defendant Subhi Abdelhalim, 911 call, February 4, 2021, confirmed at trial: *"Yes. That is my voice."* [Trial Day 8](05-TRANSCRIPTS/REPORTER-TRANSCRIPTS/Trial-Day-08-April-17-2025.pdf) · [evidence.md](evidence.md)
...
**How the appeal is organized.** The opening brief groups its assignments of error into five categories, each carrying its own standard of review. This is the part of the record that decides how much deference the verdict receives.
...
## Part 4. CGC-25-631801, the equity action

**The theory.** An independent action in equity to set aside the judgment for extrinsic fraud, plus intentional misrepresentation, concealment, constructive fraud (Civ. Code sections 1709, 1710(1), 1710(3), 1573), and attorney deceit (Bus. and Prof. Code section 6128(a)).

The claim is not that the Rules of Professional Conduct create a private right of action. It is narrower and older than that. By appearing of record and making affirmative tribunal-directed representations, counsel undertook a duty of candor whose breach is actionable under *Kulchar v. Kulchar* (1969) 1 Cal.3d 467, *In re Marriage of Modnick* (1983) 33 Cal.3d 897, and *Shafer v. Berger, Kahn* (2003) 107 Cal.App.4th 54. Extrinsic fraud is the doctrine for exactly this situation: not an error inside a fair contest, but conduct that kept a fair contest from happening.
...
## Part 5. CGC-25-631802, the denial-letter action

**The theory.** Negligent misrepresentation under Civil Code section 1710(2). It is deliberately **not** a third-party bad-faith claim, which *Moradi-Shalal v. Fireman's Fund Ins. Cos.* (1988) 46 Cal.3d 287 forecloses. The distinction is the whole case.

An insurer owes no duty to a third-party claimant to settle. That is *Moradi-Shalal*. But an insurer that chooses to put a factual assertion in writing to that claimant has done something different from declining to settle. By issuing a written denial predicated on the positive assertion of a concluded investigation, CSAA undertook a duty under *Biakanja v. Irving* (1958) 49 Cal.2d 647 to ensure the accuracy of that representation. Insurance Code section 790.03 and 10 CCR section 2695.7 supply the standard of care, not the cause of action. The pleaded wrong is the non-performance of the investigation the letter described as already complete, and the letter is the artifact through which that non-performance reached the claimant.
...
The defense chose the special motion to strike as its vehicle to end both cases. Winning on that vehicle required characterizing a February 2021 insurance denial letter as protected petitioning activity undertaken in anticipation of litigation. Four things follow from having said so.

1. **It concedes the purpose the regulation forbids.** Under 10 CCR section 2695.7(d) a claims investigation must be thorough, fair, and objective. Saying the denial was adversarial in purpose is not a defense to a concealment claim. It is the claim. See [IMMUNITY-MAPPING-TO-BAD-FAITH-SIGNAL.md](IMMUNITY-MAPPING-TO-BAD-FAITH-SIGNAL.md).
2. **It overclaims the privilege.** The denial letter predates the litigation it is now said to anticipate, which puts it outside the *Action Apartment* predicate and makes a litigation-privilege theory a misfit for an ordinary-course claims communication.
...
The August 21, 2026 Porter Scott mailbox export is published in full, so a reader can check the curated classes above against the raw mail. **302 messages across 103 email threads**, every one of them a readable page with its own link.

| Set | Files | What it is |
|-----|-------|------------|
| [THREADS.md](correspondence/full-archive/THREADS.md) | all 302 | Every thread, in ten chronological groups, each introduced by a paragraph explaining what that stretch of correspondence is about. Start here. |
| [outbound/INDEX.md](correspondence/full-archive/outbound/INDEX.md) | 191 | Rosario-sent bodies by date, with subject and correspondent. Withheld spans carry a visible marker that does not describe the withheld words. |
...
| [CHALLENGED-SET.md](correspondence/full-archive/CHALLENGED-SET.md) | map | Export IDs mapped to the exhibit and the paper that lodged them. |

Overview and reading rules: [correspondence/full-archive/README.md](correspondence/full-archive/README.md).
