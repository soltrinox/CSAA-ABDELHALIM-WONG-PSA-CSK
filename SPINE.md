...
```mermaid
flowchart TB
  subgraph trialLayer ["Underlying trial CGC-21-594102"]
    T["Reporter and clerk transcripts plus exhibits"]
  end
  subgraph appealLayer ["Appeal A173827"]
    A["Appellate briefs and augmentation motion"]
  end
  subgraph equityLayer ["Equity CGC-25-631801"]
    E["SAC fraud on court papers and exhibits"]
  end
